"""Fine-tune microsoft/deberta-base to predict redacted tokens.
...
tokenizer = AutoTokenizer.from_pretrained(f"{DATA_ROOT}/Tokenizer Files/DeBERTa_tokenizer") #load just the tokenizer
...
training_args = TrainingArguments(
    output_dir=f"{DATA_ROOT}/Models/Deberta",
    # output_dir="models",
...
# Train model
# trainer.train()
# trainer.save_model(f"{DATA_ROOT}/Models/Deberta")
...
# print(test(f"{DATA_ROOT}/Models/Deberta", training_args, tokenized_data_ds, 1914))
...
get_samples(f"{DATA_ROOT}/Models/Deberta", tokenized_data_ds)
